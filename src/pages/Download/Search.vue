          ...
          <form action="" class="form" @submit.stop.prevent="submitSearch()">
            ...
            >
                  ...
                  <div class="col-3">
                    <div class="form-group">
                      ...
                      <v-select
                        ...
                        v-model="data.site"
                        :on-change="
                          generateOnProjectSiteSelectorChangeHandler(did)
                        "
                        :placeholder="'請選擇樣區'"
                      />
                    </div>
              ...
              <div class="form-action">
                <a v-if="did > 0" @click="removeFormData(did)"
                ...
                <div class="form-group">
                  ...
                  <div class="input-group-inline">
                    ...
                    <div class="input-group ml-2">
                      <vue-timepicker v-model="form.startTime" format="" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12">
                ...
                <a class="link" @click="advSecOpen = !advSecOpen">
                  ...
                  <span class="icon">
                    <i
                      :class="
                        advSecOpen ? 'icon-chevron-up' : 'icon-chevron-down'
                      "
                    ></i>
                  </span>
                </a>
            ...
            <div id="adv-block" v-if="advSecOpen">
              <div class="row">
                <div
                  ...
                  :key="dataField.key"
                  :class="{
                    'col-2': dataField.type === 'select',
                    'col-4': dataField.type === 'text',
                  }"
                >
                ...
                <div class="row">
                  ...
                  <div class="col-3">
                    <div class="form-group">
                      ...
                      <v-select
                        ...
                        :on-change="
                          generateOnProjectSiteSelectorChangeHandler()
                        "
                  ...
                  <div class="col-3">
                    <div class="form-group">
                      ...
                      <v-select
                        :options="
                          getProjectSubSiteOptions(
                            calcForm.project.value,
                            calcForm.site.value,
                          )
                        "
                        :on-change="
                          generateOnProjectSubSiteSelectorChangeHandler()
                        "
                  ...
                  <div class="col-3">
                    <div class="form-group">
                      ...
                      <v-select
                        ...
                        :options="
                          getProjectCameraMd5Options(
                            calcForm.project.value,
                            calcForm.site.value,
                            calcForm.subSite.value,
                          )
                        "
                        multiple
                        :placeholder="'請選擇相機位置'"
              ...
              <div class="col-4">
                <div class="form-group">
                  ...
                  <div class="input-group-inline">
                    ...
                    <div class="input-group ml-2">
                      <vue-timepicker v-model="calcForm.fromTime" format="" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-4">
                <div class="form-group">
                  ...
                  <div class="input-group-inline">
                    ...
                    <div class="input-group ml-2">
                      <vue-timepicker v-model="calcForm.toTime" format="" />
                    </div>
                  </div>
                </div>
              </div>
...
const project = createNamespacedHelpers('projects');
...
export default {
  ...
  methods: {
    ...project.mapActions(['getProjects']),
    ...
    findDataField(key) {
      /*
      Find the data field from dataFields.
      @param key {string}
      @returns {dataFields|null}
       */
      for (let index = 0; index < this.dataFields.length; index += 1) {
        if (this.dataFields[index].key === key) {
