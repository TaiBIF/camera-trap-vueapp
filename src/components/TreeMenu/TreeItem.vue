<template>
  <li class="tree-menu-item" :class="{ 'is-open': CurrentToggle == idx }">
    <div
    ...
    >
      ...
      <div class="icon float-right" v-if="locked">
        <i class="icon-lock-green"></i>
      </div>
      <div class="icon float-right" v-if="haveAbnormal">
        <i class="has-error"></i>
      </div>
    </div>
    <!-- Print 出所有子項目 -->
...
import TreeItem from '@/components/TreeMenu/TreeItem';
